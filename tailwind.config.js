		...
		extend: {
			colors: {
				...
				secondary: {
					...
					shade: 'var(--grida-color-secondary-shade)',
					tint: 'var(--grida-color-secondary-tint)',
					item: 'rgba(var(--ion-color-secondary-rgb), 0.14)',
				},
				tertiary: {
					DEFAULT: 'var(--ion-color-tertiary)',
					hover: 'rgba(var(--ion-color-tertiary-rgb), 0.45)',
					rgb: 'var(--grida-color-tertiary-rgb)',
					shade: 'var(--grida-color-tertiary-shade)',
					tint: 'var(--grida-color-tertiary-tint)',
				...
				input: {
					DEFAULT: 'var(--ion-input-background)',
					dark: 'var(--ion-input-background-dark)',
					tint: 'var(--ion-input-tint)',
				},
				gray: {
					DEFAULT: 'var(--ion-color-gray-1)',
					light: 'var(--ion-color-gray-light)',
					label: 'var(--input-color)',
				},
				dark: {
					DEFAULT: 'var(--ion-color-dark)',
					shade: 'var(--ion-color-dark-shade)',
				...
				divider: {
					DEFAULT: 'var(--ion-color-divider)',
				},
				sidebar: {
					DEFAULT: 'var(--ion-color-sidebar)',
				},
			},
			fontFamily: {
